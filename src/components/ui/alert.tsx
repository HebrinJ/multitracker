...
const alertVariants = cva("relative w-full rounded-lg border px-4 py-3 text-sm has-[>svg~*]:pl-11 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground", {
  variants: {
    variant: {
